...
const FormularioInscripcionEfectivo = ({ onSubmitSuccess = () => { }, onVolver = () => { } }) => {
    const { registrarInscripcionEfectivo, agregarParticipanteTemporal } = useInscripciones();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const participante = {
                ...
                monto_cop: Number(formData.monto_cop),
                modalidad: "presencial",
                dias_asistencia: "sábado",
                forma_pago: "efectivo",
                url_pago: ""
            };

            await registrarInscripcionEfectivo([participante]);
        ...
        <div className="form-efectivo__pagina">
            <div className="form-efectivo__contenedor">
                ...
                <form onSubmit={handleSubmit} className="form-efectivo__formulario">
                    ...
                    <label htmlFor="monto_cop" className="form-efectivo__label">
                    ...
                    <select
                        ...
                        className="form-efectivo__input"
                        required
                    >
                        <option value="">Selecciona un monto</option>
                        <option value="75000">75.000 COP</option>
                        <option value="90000">90.000 COP</option>
                    </select>
                    ...
                    <button
                        className="form-efectivo__btn form-efectivo__btn--enviar"
                        type="submit"
                        disabled={enviando}
                    >
                    ...
                    <button
                        type="button"
                        className="form-efectivo__btn form-efectivo__btn--cancelar"
